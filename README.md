...
## Requisitos:
### Rotas da aplicação:
<b>[POST] </b> /obras :  A rota deverá receber titulo, editora, foto, e autores dentro do corpo da requisição. Ao cadastrar um novo projeto, ele deverá ser armazenado dentro de um objeto no seguinte formato: { "id:" 1, "titulo:" "Harry Potter", "editora:" "Rocco", "foto": "https://i.imgur.com/UH3IPXw.jpg", "autores": ["nomeAutor:" "JK Rowling", "..."]};<br><br>
